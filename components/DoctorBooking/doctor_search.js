            ...
            <div className="container">
                <div className="row row-custom">
                    <div className="col-12 col-lg-8">
                        <p className="fs-2 p-custom-title py-1">3 <a
                            className="a-custom-appoinment">Cardiologist</a> Found Near You</p>
                    </div>
                            ...
                            <div className="row row-custom">
                                <div className="col-9 col-md-10">
                                    <input type="search" className="form-control form-control-custom p-3 search-color"
                                           placeholder="Search for Doctors & Clinics" aria-label="Search"
